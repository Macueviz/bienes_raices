...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source scrset="build/img/blog3.webp" type="image/webp">
                    <source scrset="build/img/blog3.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/blog3.jpg" alt="Texto entrada blog">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="entrada.php">
                    <h4>Salon acogedor</h4>
                    <p class="informacion-meta">Escrito el: <span>24/06/21</span> por: <span>Admin</span></p>
                    <p>Consejos para construir una terraza en el techo de tu casa con los mejores materiales
                        y ahorrando dinero
                    </p>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source scrset="build/img/blog4.webp" type="image/webp">
                    <source scrset="build/img/blog4.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/blog4.jpg" alt="Texto entrada blog">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="entrada.php">
                    <h4>Una habitación íntima</h4>
                    <p class="informacion-meta">Escrito el: <span>24/06/21</span> por: <span>Admin</span></p>
                    <p>Maximiza el espacio en tu hogar con esta guia, aprende a combinar muebles y colores
                        para darle vida a tu espacio
                    </p>
